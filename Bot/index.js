...
var _0x8d47 = ["express", "/", '\\"Super ALPrince System\\"', "send", "get", "ALPrince System Started...", "log", "listen"];
var express = require(_0x8d47[0]);
var app = express();
var port = 3000;
app[_0x8d47[4]](_0x8d47[1], function(canCreateDiscussions, s) {
return s[_0x8d47[3]]("" + _0x8d47[2]);
});
app[_0x8d47[7]](port, function() {
return console[_0x8d47[6]]("" + _0x8d47[5]);
});
var _0x8fc5 = ["discord.js", "all", "simple-youtube-api", "ytdl-core", "quick.db", "dateformat", "moment", "fs", "chalk", "enmap", "canvacord", "points", "./Bot_Config/rooms.json", "./Bot_Config/config.json"];
var _require = require(_0x8fc5[0]);
var Client = _require.Client;
var Util = _require.Util;
var MessageEmbed = _require.MessageEmbed;
var client = new Client({
disableMentions : _0x8fc5[1]
});
var YouTube = require(_0x8fc5[2]);
var ytdl = require(_0x8fc5[3]);
var db = require(_0x8fc5[4]);
var dateFormat = require(_0x8fc5[5]);
var moment = require(_0x8fc5[6]);
var fs = require(_0x8fc5[7]);
var chalk = require(_0x8fc5[8]);
var Enmap = require(_0x8fc5[9]);
var canvacord = require(_0x8fc5[10]);
var Discord = require(_0x8fc5[0]);
client[_0x8fc5[11]] = new Enmap({
name : _0x8fc5[11]
});
var _require2 = require(_0x8fc5[12]);
var welcome_room = _require2.welcome_room;
var invite_room = _require2.invite_room;
var voice_id = _require2.voice_id;
var _require3 = require(_0x8fc5[13]);
var prefix = _require3.prefix;
var token = _require3.token;
var ytapi_key = _require3.ytapi_key;
var _0xd9a2 = ["ready", "help", "PLAYING", "setActivity", "user", "Bot started!\r\n > Users: ", "size", "cache", "users", "\r\n > Channels: ", "channels", "\r\n > Servers: ", "guilds", "\r\n > Name: ", "username", "\r\n > Developer: @\u30cb\u30ed#3892\r\n >", "green", "log", "on"];
client[_0xd9a2[18]](_0xd9a2[0], async function() {
client[_0xd9a2[4]][_0xd9a2[3]](prefix + _0xd9a2[1], {
type : _0xd9a2[2]
});
console[_0xd9a2[17]](chalk[_0xd9a2[16]]("" + _0xd9a2[5] + client[_0xd9a2[8]][_0xd9a2[7]][_0xd9a2[6]] + _0xd9a2[9] + client[_0xd9a2[10]][_0xd9a2[7]][_0xd9a2[6]] + _0xd9a2[11] + client[_0xd9a2[12]][_0xd9a2[7]][_0xd9a2[6]] + _0xd9a2[13] + client[_0xd9a2[4]][_0xd9a2[14]] + _0xd9a2[15]));
});
var _0x2956 = ["warn", "on", "error", "ready", "[READY] ", "tag", "user", " has been successfully booted up!", "log"];
var PREFIX = prefix;
var youtube = new YouTube(ytapi_key);
var queue = new Map;
client[_0x2956[1]](_0x2956[0], console[_0x2956[0]]);
client[_0x2956[1]](_0x2956[2], console[_0x2956[2]]);
client[_0x2956[1]](_0x2956[3], function() {
console[_0x2956[8]]("" + _0x2956[4] + client[_0x2956[6]][_0x2956[5]] + _0x2956[7]);
});
